...
Use `/metrics` to view the scraped metrics.
...
Make sure to add the Prometheus URL to the datasource:
...
3. Select **Embed**
4. Copy the iframe
5. Plug it into your HTML

You might need to configure the iframe for things such as:
